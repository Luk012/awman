...
public class RedFarBun extends LinearOpMode {
    ...
    public static double x_purple_preload_center = -57.5, y_purple_preload_center = -22, angle_purple_preload_center = 191;
    public static double x_purple_preload_left = -66, y_purple_preload_left = -24.5, angle_purple_preload_left = 167;
    ...
    public static double x_yellow_preload_center = 41, y_yellow_preload_center = -29.3, angle_yellow_preload_center = 180;
