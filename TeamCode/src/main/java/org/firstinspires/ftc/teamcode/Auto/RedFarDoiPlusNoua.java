...
@Config
@Autonomous(group = "Auto" , name = "RedFar 2+9")

public class RedFarDoiPlusNoua extends LinearOpMode {
    ...
    //TODO: only one collect pose + tuning for the fifth cycle
    ...
    public static double x_collect_cycle_4 = -22.6, y_collect_cycle_4 = -9, angle_collect_cycle_4 = 181;

    public static double x_collect_cycle_5 = 30, y_collect_cycle_5 = -9, angle_collect_cycle_5 = 190;

    public static double x_collect_cycle_6 = 30, y_collect_cycle_6 = -9, angle_collect_cycle_6 = 190;
    ...
    //TODO: tune x and y and be sure to have continuous trajectories - angles
    public static double x_score_second_cycle = 44.3, y_score_second_cycle = -4.2, angle_score_second_angle = 180;
    public static double x_score_third_cycle = 44.3, y_score_third_cycle = -5, angle_score_third_angle = 181;
    public static double x_score_forth_cycle = 44.3, y_score_forth_cycle = -9, angle_score_forth_angle = 181;
    public static double x_score_fifth_cycle = 44.3, y_score_fifth_cycle = -9, angle_score_fifth_angle = 181;
    public static double x_score_sixth_cycle = 44.3, y_score_sixth_cycle = -9, angle_score_sixth_angle = 181;
...
//
        ...
        Pose2d collect_cycle5 = new Pose2d(x_collect_cycle_5, y_collect_cycle_5, Math.toRadians(angle_collect_cycle_5));

        Pose2d collect_cycle6 = new Pose2d(x_collect_cycle_6, y_collect_cycle_6, Math.toRadians(angle_collect_cycle_6));
        ...
        Pose2d score_fifth_cycle = new Pose2d(x_score_fifth_cycle, y_score_fifth_cycle, Math.toRadians(angle_score_fifth_angle));
        Pose2d score_sixth_cycle = new Pose2d(x_score_sixth_cycle, y_score_sixth_cycle, Math.toRadians(angle_score_sixth_angle));
        ...
        TrajectorySequence COLLECT_CYCLE_3 = drive.trajectorySequenceBuilder(score_second_cycle)
                .lineToLinearHeading(collect_cycle3)
                .build();

        TrajectorySequence COLLECT_CYCLE_4 = drive.trajectorySequenceBuilder(score_third_cycle)
                .lineToLinearHeading(collect_cycle4)
                .build();

        TrajectorySequence COLLECT_CYCLE_5 = drive.trajectorySequenceBuilder(score_forth_cycle)
                .lineToLinearHeading(collect_cycle5)
                .build();

        TrajectorySequence COLLECT_CYCLE_6 = drive.trajectorySequenceBuilder(score_fifth_cycle)
                .lineToLinearHeading(collect_cycle6)
                .build();
        ...
        TrajectorySequence SCORE_FIFTH_CYCLE = drive.trajectorySequenceBuilder(collect_cycle5)
                .lineToLinearHeading(score_fifth_cycle)
                .build();

        TrajectorySequence SCORE_SIXTH_CYCLE = drive.trajectorySequenceBuilder(collect_cycle6)
                .lineToLinearHeading(score_sixth_cycle)
                .build();
            ...
            switch (status) {
                ...
                case GO_SCORE_CYCLE:
                {
                    ...
                    switch (nrcicluri)
                    {
                        ...
                        case 3:
                        {
                            drive.followTrajectorySequenceAsync(SCORE_FIFTH_CYCLE);
                            break;
                        }
                        case 4:
                        {
                            drive.followTrajectorySequenceAsync(SCORE_SIXTH_CYCLE);
                            break;
                        }
                    }
                    redFarAutoController.CurrentStatus = RedFarAutoController.autoControllerStatus.TRANSFER_BEGIN;
                ...
                {r.collect.setPower(0);
                    ...
                    {
                        redFarAutoController.CurrentStatus = RedFarAutoController.autoControllerStatus.SCORE_CYCLE_BEGIN_DOI_PLUS_NOUA;
                        nrcicluri +=1;
                        score.reset();
                ...
                case SCORE_CYCLE:
                {
                    if(!drive.isBusy() && redFarAutoController.CurrentStatus == RedFarAutoController.autoControllerStatus.SCORE_CYCLE_DONE_DOI_PLUS_NOUA && score.seconds() > 0.25)
                    {
                        redFarAutoController.CurrentStatus = RedFarAutoController.autoControllerStatus.LATCH_DROP;
                        ...
                        switch (nrcicluri)
                        {
                            ...
                            case 3:
                            {
                                drive.followTrajectorySequenceAsync(COLLECT_CYCLE_5);
                                break;
                            }
                            case 4:
                            {
                                drive.followTrajectorySequenceAsync(COLLECT_CYCLE_6);
                                break;
                            }
